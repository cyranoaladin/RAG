...
`main_head=f9b4294a5d86c09f35442bd01598faa44711c38e`
...
| `go_live_qualification_blockers` | 12 |
| `pii_undecided` | 149 |
...
| `disk_free_bytes` | 220517441536 |
| `disk_used_percent` | 72 |
| `disk_policy_ok` | True |
