...
| --- | --- | --- | --- | --- |
| `P1_PRE_RELEASE` Fermer les bloqueurs de pre-release | fermee | — | — | — |
| `P2_DEPOT` Vider le depot de ses PR bloquantes | fermee | — | — | — |
| `P3_OCTETS` Disposer des octets des contenus servables | fermee | — | — | — |
| `P4_QUALIFICATION` Fermer les gates de qualification | actionnable | GO_LIVE_QUALIFICATION_BLOCKERS | — | MIXED |
