...
| `GO_LIVE_QUALIFICATION_BLOCKERS` | 11 | oui | MIXED | Chaque entree du tableau porte closed=true et sa preuve. |
| `OPEN_PRS_BLOCKING` | 4 | oui | HUMAN_DECISION | Aucune disposition BLOCKING ni UNKNOWN. |
