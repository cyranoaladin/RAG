...
def create_collection_with_test_doc():
    """Créer la collection en insérant un document test"""
    print("Création de la collection rag_maths_3e_dnb via document test...")
    
    # Préparer le payload pour créer la collection
    payload = {
...
def main():
    ...
    # Créer la collection
    success = create_collection_with_test_doc()
