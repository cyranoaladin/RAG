...
L’auditeur `pilot-golden-spec-audit` vérifie exhaustivement les 255 requêtes, les cardinalités, le scope, les taxonomies, les seuils, l’unicité, le contenu et l’absence récursive de champs prétendant connaître des résultats réels. La revue humaine reste indépendante dans `configs/pilot_golden_human_review.yml` et n’est approuvée que si sa preuve exhaustive, confinée et liée par SHA-256 concorde exactement avec le paquet normatif.
