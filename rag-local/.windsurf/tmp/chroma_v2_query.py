...
def get_collection_documents_v2(collection_name, limit=1000):
    """Récupérer les documents d'une collection avec l'API v2"""
    url = f'{CHROMA_URL}/api/v2/collections/{collection_name}/get'
...
def list_collections_v2():
    """Lister toutes les collections avec l'API v2"""
...
results = get_collection_documents_v2('rag_education', limit=1000)
