...
- Horaire : 4 h 30/semaine.
- Collection cible : `rag_nexus_francais_troisieme_tc` (ADR-0015 — convention rag_nexus_{matiere}_{niveau}_{voie}_{statut}).

## 2. Programme officiel (BOEN_special_11_2018-07-26_aj_2020)
- **Lecture et culture littéraire** : Récits d'aventure et fiction policière, Fiction et merveilleux, Théâtre : texte et représentation, Poésie : dire le monde et l'intime, Textes argumentatifs et débat d'idées.
- **Grammaire et orthographe** : Classes de mots et fonctions, Temps et modes verbaux, Phrase simple et phrase complexe, Orthographe grammaticale et lexicale.
- **Écriture et oral** : Écriture narrative et descriptive, Écriture argumentative, Lecture à voix haute, présentation d'une œuvre, histoire des arts.
...
## 6. Notes RAG / corpus
- Taxonomie : `services/rag-pedago/taxonomy/francais/troisieme.yml` (thèmes → notions → compétences).
- Indexer par **thème puis notion** ; métadonnées obligatoires : `niveau=troisieme`, `voie=college`, `matiere=francais`, `statut_enseignement=tronc_commun`, `session` (declared_or_null), `audience` (libre/aefe/tous).
