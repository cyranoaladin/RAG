...
- Collection cible : `rag_nexus_pc_troisieme_tc` (ADR-0015 — convention rag_nexus_{matiere}_{niveau}_{voie}_{statut}).

## 2. Programme officiel (BOEN_special_11_2018-07-26_aj_2020)
- **Chimie : transformations de la matière** : Ions et pH, Réactions chimiques et conservation de la masse.
- **Mécanique** : Gravitation, poids et masse, Forces et mouvements.
- **Électricité** : Circuits électriques en série et en dérivation, Tension, intensité et loi d'Ohm.
- **Énergie et signaux** : Formes d'énergie et conversions, Lumière et son : propagation et signaux.
...
## 6. Notes RAG / corpus
- Taxonomie : `services/rag-pedago/taxonomy/physique_chimie/troisieme.yml` (thèmes → notions → compétences).
- Indexer par **thème puis notion** ; métadonnées obligatoires : `niveau=troisieme`, `voie=college`, `matiere=pc`, `statut_enseignement=tronc_commun`, `session` (declared_or_null), `audience` (libre/aefe/tous).
