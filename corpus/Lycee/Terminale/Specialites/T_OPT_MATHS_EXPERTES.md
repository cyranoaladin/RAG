# Option Maths expertes — Terminale
...
- Horaire : 3 h/semaine (réservée aux élèves de spécialité maths).
- Collection cible : `rag_nexus_maths_terminale_gen_option_exp` (ADR-0015 — convention rag_nexus_{matiere}_{niveau}_{voie}_{statut}).

## 2. Programme officiel (BOEN_special_8_2019-07-25)
- **Algèbre et structures** : Nombres complexes, Arithmétique : divisibilité, congruences, Matrices et suites, Théorie des graphes.
- **Géométrie approfondie** : Géométrie de l'espace approfondie.
...
## 6. Notes RAG / corpus
- Taxonomie : `services/rag-pedago/taxonomy/maths/terminale_gen_option_exp.yml` (thèmes → notions → compétences).
