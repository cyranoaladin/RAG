...
- Horaire : 6 h/semaine.
- Collection cible : `rag_nexus_pc_terminale_specialite` (ADR-0015 — convention rag_nexus_{matiere}_{niveau}_{voie}_{statut}).

## 2. Programme officiel (BOEN_special_8_2019-07-25)
- **Constitution et transformations de la matière** : Évolution des systèmes chimiques, Acide-base : pH et équilibres, Oxydoréduction : piles et électrolyse, Mécanismes réactionnels en chimie organique, Stratégie de synthèse organique.
- **Mouvement et interactions** : Mouvement dans un champ uniforme, Lois de Kepler, satellites et planètes, Système oscillant et aspect énergétique.
- **Fluides et énergie** : Écoulements et machines thermiques, Premier principe et énergie interne.
- **Ondes et signaux** : Interférences et diffraction, Optique : du modèle géométrique au modèle ondulatoire.
...
## 6. Notes RAG / corpus
- Taxonomie : `services/rag-pedago/taxonomy/physique_chimie/terminale_specialite.yml` (thèmes → notions → compétences).
- Indexer par **thème puis notion** ; métadonnées obligatoires : `niveau=terminale`, `voie=generale`, `matiere=pc`, `statut_enseignement=specialite`, `session` (declared_or_null), `audience` (libre/aefe/tous).
