...
- Horaire : 6 h/semaine.
- Collection cible : `rag_nexus_ses_terminale_specialite` (ADR-0015 — convention rag_nexus_{matiere}_{niveau}_{voie}_{statut}).

## 2. Programme officiel (BOEN_special_8_2019-07-25)
- **Science économique** : Croissance, capital et progrès technique, Globalisation et finance, Structures des marchés et concurrence, Défaillances du marché et régulation.
- **Sociologie et science politique** : Déviance et contrôle social, Travail, emploi et chômage, Mobilité sociale.
- **Regards croisés** : Justice sociale et inégalités, Confiance et économie.
...
## 6. Notes RAG / corpus
- Taxonomie : `services/rag-pedago/taxonomy/ses/terminale_specialite.yml` (thèmes → notions → compétences).
- Indexer par **thème puis notion** ; métadonnées obligatoires : `niveau=terminale`, `voie=generale`, `matiere=ses`, `statut_enseignement=specialite`, `session` (declared_or_null), `audience` (libre/aefe/tous).
