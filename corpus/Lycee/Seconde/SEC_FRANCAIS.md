...
- Horaire : 4 h/semaine.
- Collection cible : `rag_nexus_francais_seconde_tc` (ADR-0015 — convention rag_nexus_{matiere}_{niveau}_{voie}_{statut}).

## 2. Programme officiel (BOEN_special_1_2019-01-22)
- **Littérature** : Poésie de l'Antiquité au XIXe siècle, Roman et récit : formes et enjeux, Théâtre : du texte à la scène, Essai et écriture argumentative.
- **Langue et grammaire** : Grammaire du texte et de la phrase, Énonciation et points de vue.
- **Expression écrite et orale** : Écriture d'invention, Présentation et commentaire oral.
...
## 6. Notes RAG / corpus
- Taxonomie : `services/rag-pedago/taxonomy/francais/seconde_tc.yml` (thèmes → notions → compétences).
- Indexer par **thème puis notion** ; métadonnées obligatoires : `niveau=seconde`, `voie=generale`, `matiere=francais`, `statut_enseignement=tronc_commun`, `session` (declared_or_null), `audience` (libre/aefe/tous).
